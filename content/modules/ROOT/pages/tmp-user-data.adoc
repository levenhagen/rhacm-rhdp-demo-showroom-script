...
Enable dev-mode (see xref:tmp-content-repo.adoc[]) to see all attributes available in your deployed environment.

== Next Steps

* xref:tmp-ui-config.adoc[] -- configure tabs, layout, and dynamic URLs.
* xref:tmp-content-repo.adoc[] -- structure your content repo and use attributes effectively.
