...
----
<1> Optional -- enables OCP console embedding in Showroom iframes. See xref:tmp-ocp-integration.adoc[].
...
|===
+
See xref:tmp-content-repo.adoc#_dev_mode[Dev Mode] for what it provides and xref:tmp-ocp4-role-reference.adoc#_dev_mode[OCP4] / xref:tmp-vm-role-reference.adoc#_dev_mode[VM] role references for the full variable list.
...
* xref:tmp-ocp4-role-reference.adoc[] -- full variable reference for OCP4 deployments.
* xref:tmp-vm-role-reference.adoc[] -- full variable reference for VM deployments.
* xref:tmp-user-data.adoc[] -- how provisioning data reaches your content.
