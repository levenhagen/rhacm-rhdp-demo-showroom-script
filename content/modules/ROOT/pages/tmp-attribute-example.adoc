...
TIP: Always provide sensible defaults in `content/antora.yml` so your content renders correctly during local development. See xref:tmp-user-data.adoc[] for the full injection flow.
